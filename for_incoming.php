					...
					<div class="header-top">
						...
						<nav class="main-menu">
							<ul>
								...
								<li>
								<a href="for_incoming.php" style="color: #fad201; text-shadow: #000000 0 0 3px;">Поступающим</a>
								<ul class="submenu">
							...
							<li>
								...
								<ul class="submenu">
										<li><a href="contacts.php" style="color: #fad201; text-shadow: #000000 0 0 3px;">Контакты</a></li>
